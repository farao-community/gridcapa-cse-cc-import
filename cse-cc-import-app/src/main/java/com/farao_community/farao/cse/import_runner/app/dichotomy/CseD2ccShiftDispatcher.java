...
import static com.farao_community.farao.cse.import_runner.app.dichotomy.CseCountry.SI;
...
public class CseD2ccShiftDispatcher implements ShiftDispatcher {
    ...
    private static final Set<String> BORDER_COUNTRIES = Set.of(FR.getEiCode(), CH.getEiCode(), AT.getEiCode(), SI.getEiCode());
    ...
    public Map<String, Double> dispatch(double value) {
        ...
        shifts.put(IT.getEiCode(), referenceItalianImport - value);
